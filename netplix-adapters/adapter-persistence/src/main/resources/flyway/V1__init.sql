DROP TABLE IF EXISTS `netplix`.`user`;
CREATE TABLE `netplix`.`user`
(
...
DROP TABLE IF EXISTS `netplix`.`social_user`;
CREATE TABLE `netplix`.`social_user`
(
...
DROP TABLE IF EXISTS `netplix`.`user_subscription`;
CREATE TABLE `netplix`.`user_subscription`
(
...
DROP TABLE IF EXISTS `netplix`.`token`;
CREATE TABLE `netplix`.`token`
(
...
DROP TABLE IF EXISTS `netplix`.`movie`;
CREATE TABLE `netplix`.`movie`
(
...
DROP TABLE IF EXISTS `netplix`.`user_movie_like`;
CREATE TABLE `netplix`.`user_movie_like`
(
...
DROP TABLE IF EXISTS `netplix`.`user_movie_download`;
CREATE TABLE `netplix`.`user_movie_download`
(
...
DROP TABLE IF EXISTS `netplix`.`user_history`;
CREATE TABLE `netplix`.`user_history`
(
